...
class CATModel(torch.nn.Module):
    ...
    def __init__(self, classes_per_task, n_head, size, nhid=2000, pdrop1=0.2, pdrop2=0.5, smax=400):
        super().__init__()
        ...
        self.kt = KnowledgeTransfer(nhid, ncha, size, self.taskcla, n_head)
        self.smax = smax
...
class MainContinualLearning(torch.nn.Module):
    ...
    def __init__(self, nhid, ncha, size, num_tasks, classes_per_task):
        ...
        self.ec1 = torch.nn.Embedding(num_tasks, 64)
...
class KnowledgeTransfer(torch.nn.Module):
    ...
    def __init__(self, nhid, ncha, size, classes_per_task, n_head):
        ...
        self.ec1 = torch.nn.Embedding(len(classes_per_task), 64)
