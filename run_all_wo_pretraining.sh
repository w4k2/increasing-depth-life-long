...
# PMNIST
python hyperparamters.py --run_name="cumulative hyperparameters w/o pretraining" --experiment "PermutedMNIST" --interactive_logger=0 --method="cumulative" --pretrained=0 --dataset="permutation-mnist" --n_experiences=20 --train_on_experiences=5 --device="cuda:0" --batch_size=32
